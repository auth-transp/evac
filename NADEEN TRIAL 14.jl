...
@agent AgentEscapes ContinuousAgent{2} begin
    ...
    concentrationmap = floor.(Int, convert.(Float64, concentration_data .*20))
...
function setupToxic()
    Atime = [0, 10, 30, 60, 240, 480] #min 
    Arho = zeros(3, 6)
    Arho[1, 2:6] = [0.50, 0.50, 0.50, 0.50, 0.50]
    Arho[2, 2:6] = [2.8, 2.8, 2.0, 1.0, 0.71]
    Arho[3, 2:6] = [50, 28, 20, 10, 7.1] #ppm
    MW = 71 #Molecular Weight of Cl2
