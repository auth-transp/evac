...
"""
PriorityQueue/Priority: ουρά προτεραιότητας με 2-κλειδιά.
OccupancyGridMap: πλέγμα εμποδίων και γειτνιάσεων.
numpy: πίνακες για g και rhs.
heuristic: μετρική (π.χ. Ευκλείδεια/Manhattan).
Vertex, Vertices: βοηθητικές δομές για αλλαγμένα ακμές.
typing: hints.
"""
...
UNOCCUPIED = 0
"""
Συμβολικές τιμές καταληψιμότητας. 255=εμπόδιο, 0=ελεύθερο.
"""
