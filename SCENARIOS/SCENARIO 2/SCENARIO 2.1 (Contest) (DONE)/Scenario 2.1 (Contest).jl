...
begin   # Δημιουργία animation με trails & συλλογή CSV θέσης και toxicload
    ...
    video_file = "SCENARIO 2.1 (Contest) (DONE)/Simulation Results/SCENARIO_2.1_$(seed)_$(run_timestamp).mp4"
    ...
    csv_file = "SCENARIO 2.1 (Contest) (DONE)/Simulation Results/SCENARIO_2.1_$(seed)_$(run_timestamp).csv"
