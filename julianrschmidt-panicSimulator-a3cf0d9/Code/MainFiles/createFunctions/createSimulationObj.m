...
%simulationObj.ConcentrationMap=createConcentrationMap([0, settings.xMax, 0, settings.yMax]);
...
a1=0.240;         
b1=0.290;
NAgent=size(agents,1);
agents(:,5)=(b1-a1).*rand(NAgent,1) + a1;   % Radius Randomization
