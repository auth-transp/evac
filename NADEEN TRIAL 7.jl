...
@agent AgentEscapes ContinuousAgent{2} begin
    ...
    #heightmap_url = "Maps/petromax refining borders.png"
    #heightmap = floor.(Int, convert.(Float64, heightmap_url)*255)
    #heightmap = floor.(Int, Float32.(Gray.(load(heightmap_url))) * 255) .+ 1
